...
namespace GlocalCart.API.Services.Interfaces
{
    public interface IShipperService
    {
        ...
        Task<PagedResult<ShipperShipmentDto>> GetCompletedShipmentsAsync(int shipperId, int page, int pageSize, string? period = null);
        ...
        Task<ShipperShipmentDto> ReportDeliveryFailedAsync(int shipperId, int shipmentId, string? reason, string? note);
    }
}
